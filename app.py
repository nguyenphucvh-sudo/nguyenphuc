...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Phúc - Trường Tiểu học Vĩnh Hảo - ĐT: 091 2604 177</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Phúc - Trường Tiểu học Vĩnh Hảo - ĐT: 091 2604 177</div>", unsafe_allow_html=True)
